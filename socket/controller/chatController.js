...
class ChatController {
    ...
    handleConnection(socket) {
      ...
      socket.on("chat:join", (room) => this.joinRoom(socket, room));
      socket.on("chat:leave", (room) => this.leaveRoom(socket, room));
      socket.on("chat:send", (data) => this.sendMessage(socket, data));
